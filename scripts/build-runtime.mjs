...
const runtimeFiles = Object.freeze([
    ...
    Object.freeze({ path: 'cli/install/creator-occupancy.mjs', mode: 0o644 }),
    Object.freeze({ path: 'cli/install/lite-project-installer.mjs', mode: 0o644 }),
    Object.freeze({ path: 'cli/install/product-archive.mjs', mode: 0o644 }),
